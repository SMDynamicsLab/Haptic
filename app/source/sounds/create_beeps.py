...
# based on : https://stackoverflow.com/questions/4201852/how-do-i-create-a-series-of-high-and-low-pitch-beeps-using-ruby-or-python
...
# # Single beep
# append_sinewave(duration_milliseconds=beep_duration)
# save_wav(f"beep_{beep_duration}.wav")