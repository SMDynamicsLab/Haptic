...
int main(int argc, char* argv[])
{
    ...
    cout << "[up/down] - Increase/Decrease size of walls" << endl;
    ...
    base->m_material->setStiffness(1 * maxStiffness);
    ...
    // create a sphere
    box0 = new cShapeBox(0.1,boxSize,boxSize);
    world->addChild(box0);

    // set position
    box0->setLocalPos(0.0,0.0, 0.0);
    
    // set material color
    box0->m_material->setRedDarkSalmon();
    ...
    // create a sphere
    box1 = new cShapeBox(0.1,boxSize,boxSize);
    world->addChild(box1);
...
void keyCallback(GLFWwindow* a_window, int a_key, int a_scancode, int a_action, int a_mods)
{
    ...
    {   
        boxSize += 0.1;
        box0 -> setSize(0.1,boxSize,boxSize);
        box1 -> setSize(0.1,boxSize,boxSize);
    }
